...
fun VacancyScreen(navController: NavController, vacancy: VacancyModel) {
    ...
    Scaffold(
        ...
        Column(
            ...
            CustomText(heading = "Имя соискателя", content = vacancy.companyName)
            Spacer(modifier = Modifier.padding(8.dp))
            CustomText(heading = "Тип занятости", content = vacancy.formOfEmployment)
            Spacer(modifier = Modifier.padding(8.dp))
            CustomText(heading = "Образование", content = vacancy.requirements)
            Spacer(modifier = Modifier.padding(8.dp))
            CustomText(heading = "Расположение", content = vacancy.location)
            Spacer(modifier = Modifier.padding(8.dp))
            CustomText(heading = "Ожидаемая заработная плата", content = vacancy.salary.toString())
            Spacer(modifier = Modifier.padding(8.dp))
            CustomText(heading = "О соискателе", content = vacancy.about)
            Spacer(modifier = Modifier.padding(8.dp))
            Button(
